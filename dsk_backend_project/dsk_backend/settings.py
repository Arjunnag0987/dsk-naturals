...
ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS", "127.0.0.1,localhost,68.178.170.144,dsknaturals.com,www.dsknaturals.com").split(",")
CSRF_TRUSTED_ORIGINS = [
    "https://dsknaturals.com",
    "https://www.dsknaturals.com"
]
